...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=192, patch_size=8, in_chans=4, embed_dim=768):
        super().__init__()
...
class VisionTransformer(nn.Module):
    ...
    """
    def __init__(self, img_size=192, patch_size=8, in_chans=4, num_classes=1000, embed_dim=768, depth=12,
